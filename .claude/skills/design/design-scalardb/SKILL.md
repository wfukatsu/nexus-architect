...
description: |
  ...
  /design-scalardb で呼び出し。ScalarDB利用プロジェクト専用。
  Do NOT use for projects not using ScalarDB (use /design-data-layer instead).
model: opus
user_invocable: true
---
...
| reports/01_analysis/data-model-analysis.md | 推奨 | /analyze-data-model |
