...
3. Read `reports/01_analysis/ubiquitous-language.md` — build a term lookup table from the "Domain Term" column (localized when output_language is not "en", e.g. "業務用語" for ja)
