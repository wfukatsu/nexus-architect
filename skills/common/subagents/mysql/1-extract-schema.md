...
python <PLUGIN_ROOT>/skills/migrate-mysql/analyze-mysql-schema/scripts/mysql_db_extractor.py --config .claude/configuration/databases.env <INCLUDE_SOURCE_FLAG>
