# Subagent Prompt: Oracle Schema Report Generation

**Type:** general-purpose
**Description:** Reads raw_schema_data.json and the report template, then generates oracle_schema_report.md with a complete human-readable schema analysis.
...
- REPORT_FILE: <OUTPUT_DIR>/oracle_schema_report.md
- DURATION_SECONDS: <elapsed seconds computed in step 6>
- SUMMARY: <executive summary — table count, view count, PL/SQL object count, total objects, key observations in 2-3 lines>
