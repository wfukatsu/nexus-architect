# MySQL Stored Procedure Migration Report
...
- **Total MySQL Objects**: {{TOTAL_COUNT}}
...
Shows which of the 17 feature categories each MySQL object uses:
...
| 4 | Exception handling (DECLARE HANDLER) | ScalarDB exception types |
...
```
{{OUTPUT_DIR}}/
├── scalardb_mysql_sp_migration_report.md     # This report
└── generated-java/
    ├── {{FILE_1}}
    ├── {{FILE_2}}
    └── ...
...
- [ ] Validate data type precision (especially DECIMAL → DOUBLE conversions)
