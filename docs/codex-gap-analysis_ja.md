...
> **注記（時点情報）**: 本ドキュメントは 2026-05-15 時点のスナップショットです。本文中の「51 skills」は当時の構成であり、現在は **3 plugins（product / architect / scalardb）/ 87 skills**（architect 50 / product 26 / scalardb 11）です。最新の構成は `README.md` と `.claude-plugin/marketplace.json` を参照してください。
