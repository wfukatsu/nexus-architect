...
```
/architect:scalardb-model        スキーマを設計する
        ↓
/architect:scalardb-config       設定ファイルを生成する
        ↓
/architect:scalardb-scaffold     スタータープロジェクトを生成する
        ↓
/architect:scalardb-build-app    完全なアプリケーションを構築する
        ↓
/architect:scalardb-review-code  正確性をレビューする
```

## スキル

### スキーマ設計: `/architect:scalardb-model`
...
### プロジェクトスキャフォールド: `/architect:scalardb-scaffold`
...
### アプリケーションビルダー: `/architect:scalardb-build-app`
...
### CRUD 操作ガイド: `/architect:scalardb-crud-ops`
...
### JDBC/SQL 操作ガイド: `/architect:scalardb-jdbc-ops`
...
### 例外処理: `/architect:scalardb-error-handler`
...
### コードレビュー: `/architect:scalardb-review-code`
...
### ローカル環境: `/architect:scalardb-local-env`
...
### ドキュメント検索: `/architect:scalardb-docs`
...
### マイグレーションアドバイザー: `/architect:scalardb-migrate`
